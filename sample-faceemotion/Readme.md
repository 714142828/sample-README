...
2.  <a name="li1365682471610"></a>Obtain the source network model required by the application.
    ...
    **Table  1**  Models used in the face emotion application
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p963916373173"><a name="p963916373173"></a><a name="p963916373173"></a>Download the source network model file and its weight file by referring to <strong id="b11136714151914"><a name="b11136714151914"></a><a name="b11136714151914"></a>README.md</strong> at <a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_emotion" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_emotion</a>.</p>
    </td>
    </tr>
    </tbody>
    </table>
