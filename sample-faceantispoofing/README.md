    ...
    1.  <a name="li61417158198"></a>查询当前使用的DDK版本号。
        ...
        -   使用Mind Studio工具查询。
            ...
            **图 1**  DDK版本号查询<a name="fig17553193319118"></a>  
            ![](figures/DDK版本号查询-36.png "DDK版本号查询-36")
...
3.  执行deploy脚本， 进行配置参数调整及第三方库下载编译 打开Mind Studio工具的Terminal，此时默认在代码主目录下，执行如下命令在后台指执行deploy脚本，进行环境部署。如[图 执行deploy脚本](#fig22681517439)所示。
...
5.  <a name="li499911453439"></a>启动Presenter Server。
    ...
    **图 9**  IP地址示例<a name="fig1881532172010"></a>  
    ![](figures/IP地址示例-40.png "IP地址示例-40")
...
2.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站，详细可参考[启动Presenter Server](#li499911453439)。
    ...
    **图 11**  Presenter Server界面<a name="fig113691556202312"></a>  
    ![](figures/Presenter-Server界面-41.png "Presenter-Server界面-41")
...
-   **停止Face Antispoofing应用**
    ...
    **图 12**  Face Antispoofingon应用已停止<a name="fig2182182518112"></a>  
