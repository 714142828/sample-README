...
2.  <a name="li12291771229"></a>Obtain the network model required by the application.
    ...
    **Table  1**  Model used in the crowd counting \(python\) application
    ...
    <td class="cellrowborder" valign="top" width="56.43564356435643%" headers="mcps1.2.4.1.3 "><p id="p110671813170"><a name="p110671813170"></a><a name="p110671813170"></a>Download the model file of the source network by referring to <strong id="b1233913102344"><a name="b1233913102344"></a><a name="b1233913102344"></a>README.md</strong> at <a href="https://gitee.com/HuaweiAscend/models/tree/master/computer_vision/object_detect/crowd_counting" target="_blank" rel="noopener noreferrer">https://gitee.com/HuaweiAscend/models/tree/master/computer_vision/object_detect/crowd_counting</a>.</p>
    </td>
    </tr>
    </tbody>
    </table>
