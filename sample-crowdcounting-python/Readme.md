...
2.  <a name="li12291771229"></a>获取此应用中所需要的网络模型。
    ...
    参考[表 密集人群人数统计\(python\)使用模型](#table1119094515272)获取此应用中所用到的原始网络模型及其对应的权重文件，并将其存放到Mind Studio所在Ubuntu服务器的任意目录，例如：$HOME/ascend/models/crowdcounting-python。
...
3.  将原始网络模型转换为适配昇腾AI处理器的模型。
    ...
    4.  将转换好的模型文件（.om文件）上传到[步骤1](#li953280133816)中源码所在路径下的“sample-crowdcounting-python/model”目录下。
...
3.  <a name="li156931456596"></a>启动Presenter Server。
    ...
    **图 1**  Presenter Server进程启动<a name="fig69531305324"></a>  
    ![](figures/Presenter-Server进程启动-65.png "Presenter-Server进程启动-65")
    ...
    **图 3**  IP地址示例<a name="fig1881532172010"></a>  
    ![](figures/IP地址示例-67.png "IP地址示例-67")
...
4.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站，详细可参考[启动Presenter Server](#li156931456596)。
    ...
    **图 4**  Presenter Server界面<a name="fig113691556202312"></a>  
    ![](figures/Presenter-Server界面-68.png "Presenter-Server界面-68")
