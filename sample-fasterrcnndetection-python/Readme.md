...
2.  <a name="li9634105881418"></a>执行部署脚本，进行工程环境准备，Presenter Server服务器的配置等操作，其中Presenter Server用于接收Application发送过来的数据并通过浏览器进行结果展示。
    ...
    **图 1**  工程部署示意图<a name="fig184321447181017"></a>  
...
3.  <a name="li156931456596"></a>启动Presenter Server。
    ...
    **图 2**  Presenter Server进程启动<a name="fig69531305324"></a>  
    ![](figures/Presenter-Server进程启动-57.png "Presenter-Server进程启动-57")
    ...
    **图 4**  IP地址示例<a name="fig1881532172010"></a>  
    ![](figures/IP地址示例-59.png "IP地址示例-59")
...
4.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站，详细可参考[启动Presenter Server](#li156931456596)。
    ...
    **图 5**  Presenter Server界面<a name="fig113691556202312"></a>  
    ![](figures/Presenter-Server界面-60.png "Presenter-Server界面-60")
