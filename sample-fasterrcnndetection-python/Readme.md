...
2.  安装环境依赖。
    ...
    3.  安装hiai。
        ...
        安装脚本路径：[https://github.com/AscendHuawei/tools/blob/master/python2_hiai_install.sh](https://github.com/AscendHuawei/tools/blob/master/python2_hiai_install.sh)。
