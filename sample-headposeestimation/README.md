...
# Head Pose Estimation<a name="EN-US_TOPIC_0219099583"></a>
...
2.  <a name="li1365682471610"></a>Obtain the source network model required by the application.
    ...
    Obtain the source network model and its weight file used in the application by referring to  [Table 1](#table144841813177)  and save them to the same directory on Ubuntu Server where  Mind Studio  is located, for example,  **$HOME/models/headposeestimation**.

    **Table  1**  Models used in the head pose estimation application

    <a name="table144841813177"></a>
    <table><thead align="left"><tr id="row161061318181712"><th class="cellrowborder" valign="top" width="14.000000000000002%" id="mcps1.2.4.1.1"><p id="p1410671814173"><a name="p1410671814173"></a><a name="p1410671814173"></a>Model Name</p>
    </th>
    <th class="cellrowborder" valign="top" width="23%" id="mcps1.2.4.1.2"><p id="p1106118121716"><a name="p1106118121716"></a><a name="p1106118121716"></a>Description</p>
    </th>
    ...
    <tbody><tr id="row1710661814171"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.1 "><p id="p17921089115"><a name="p17921089115"></a><a name="p17921089115"></a>face_detection</p>
    </td>
    <td class="cellrowborder" valign="top" width="23%" headers="mcps1.2.4.1.2 "><p id="p6792386120"><a name="p6792386120"></a><a name="p6792386120"></a>Network model for face detection.</p>
    <p id="p4792386118"><a name="p4792386118"></a><a name="p4792386118"></a>It is converted from the Caffe-based ResNet10-SSD300 model.</p>
    </td>
    <td class="cellrowborder" valign="top" width="63%" headers="mcps1.2.4.1.3 "><p id="p1679248219"><a name="p1679248219"></a><a name="p1679248219"></a>Download the source network model file and its weight file by referring to<strong id="b939193404411"><a name="b939193404411"></a><a name="b939193404411"></a> README.md</strong> at <a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection</a>.</p>
    </td>
    </tr>
    <tr id="row20991341914"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.4.1.1 "><p id="p4792148315"><a name="p4792148315"></a><a name="p4792148315"></a>head_pose_estimation</p>
    </td>
    <td class="cellrowborder" valign="top" width="23%" headers="mcps1.2.4.1.2 "><p id="p479212818114"><a name="p479212818114"></a><a name="p479212818114"></a>Network model for head pose estimation. It is converted from the Caffe-based VGG-SSD model.</p>
    </td>
    <td class="cellrowborder" valign="top" width="63%" headers="mcps1.2.4.1.3 "><p id="p74491026916"><a name="p74491026916"></a><a name="p74491026916"></a>Download the source network model file and its weight file by referring to <strong id="b294518818454"><a name="b294518818454"></a><a name="b294518818454"></a>README.md</strong> at <a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/head_pose_estimation" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/head_pose_estimation</a>.</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    1.  <a name="li61417158198"></a>Query the current DDK version number.
        ...
        -   Using Mind Studio
            ...
            **Figure  1**  Querying the DDK version number<a name="fig17553193319118"></a>  
            ![](figures/querying-the-ddk-version-number-40.png "querying-the-ddk-version-number-40")
    ...
    -   Convert a model using Mind Studio.
        ...
        3.  During the conversion, the error information occurs with the face\_detection model, as shown in  [Figure 2](#fig2865313121718).
            ...
            **Figure  2**  Model conversion error<a name="fig2865313121718"></a>  
            ...
            ![](figures/model_facedetection_coversionfailed-41.png)
...
5.  Upload the converted .om model file to the  **sample-head\_pose\_estimation/script**  directory under the source code path in  [Step 1](#li953280133816).
...
3.  Run the  **deploy.sh**  script to adjust configuration parameters and download and compile the third-party library. Open the  **Terminal**  window of Mind Studio. By default, the home directory of the code is used. Run the  **deploy.sh**  script in the background to deploy the environment, as shown in  [Figure 4](#fig4285173816445).

    **Figure  4**  Running the deploy.sh script<a name="fig4285173816445"></a>  
    ![](figures/running-the-deploy-sh-script-42.png "running-the-deploy-sh-script-42")
...
4.  Start building. Open Mind Studio and choose  **Build \> Build \> Build-Configuration**  from the main menu. The  **build**  and  **run**  folders are generated in the directory, as shown in  [Figure 5](#fig1625447397).

    **Figure  5**  Build and file generation<a name="fig1625447397"></a>  
...
5.  <a name="li499911453439"></a>Start Presenter Server.
    ...
    Open the  **Terminal**  tab page on Mind Studio. By default, under the code storage path, run the following command to start the Presenter Server program of the head pose estimation application on the server, as shown in  [Figure 6](#fig423515251067).

    **bash run\_present\_server.sh**

    **Figure  6**  Starting Presenter Server<a name="fig423515251067"></a>  
    ...
    Select the IP address used by the browser to access the Presenter Server service in  **Current environment valid ip list**, as shown in  [Figure 7](#fig999812514814).

    **Figure  7**  Project deployment<a name="fig999812514814"></a>  
    

    ![](figures/en-us_image_0219102259.jpg)

    [Figure 8](#fig69531305324)  shows that the Presenter Server service has been started successfully.

    **Figure  8**  Starting the Presenter Server process<a name="fig69531305324"></a>  
    

    ![](figures/en-us_image_0219102274.jpg)

    Use the URL shown in the preceding figure to log in to Presenter Server \(only Google Chrome is supported\). The IP address is that typed in  [Figure 7](#fig999812514814)  and the default port number is  **7007**. The following figure indicates that Presenter Server has been started successfully.

    **Figure  9**  Home page<a name="fig64391558352"></a>  
    ![](figures/home-page-43.png "home-page-43")

    The following figure shows the IP address used by Presenter Server and  Mind Studio  to communicate with the Atlas 200 DK.

    **Figure  10**  IP address example<a name="fig1881532172010"></a>  
    ![](figures/ip-address-example-44.png "ip-address-example-44")
...
1.  Run the head pose estimation program.
    ...
    On the toolbar of Mind Studio, click  **Run**  and choose  **Run \> Run 'sample-headposeestimation'**. As shown in  [Figure 11](#fig93931954162719), the executable program is running on the developer board.

    **Figure  11**  Application running sample<a name="fig93931954162719"></a>  
...
2.  Use the URL displayed upon the start of the Presenter Server service to log in to Presenter Server. For details, see  [Start Presenter Server](#li499911453439).
    ...
    Wait for Presenter Agent to transmit data to the server. Click  **Refresh**. When there is data, the icon in the  **Status**  column for the corresponding channel changes to green, as shown in  [Figure 12](#fig113691556202312).

    **Figure  12**  Presenter Server page<a name="fig113691556202312"></a>  
    ![](figures/presenter-server-page-45.png "presenter-server-page-45")
...
-   Stopping the head pose estimation application
    ...
    Click the stop button shown in  [Figure 13](#fig14326454172518)  to stop the head pose estimation application.

    **Figure  13**  Stopping the head pose estimation application<a name="fig14326454172518"></a>  
    

    ![](figures/en-us_image_0219102592.gif)

    [Figure 14](#fig2182182518112)  shows that the head pose estimation application has been stopped.

    **Figure  14**  Stopped the head pose estimation application<a name="fig2182182518112"></a>  
