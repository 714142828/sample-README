    ...
    1.  <a name="li61417158198"></a>查询当前使用的DDK版本号。
        ...
        -   使用Mind Studio工具查询。
            ...
            **图 1**  DDK版本号查询<a name="fig17553193319118"></a>  
            ![](figures/DDK版本号查询-42.png "DDK版本号查询-42")
...
3.  执行deploy脚本， 进行配置参数调整及第三方库下载编译 打开Mind Studio工具的Terminal，此时默认在代码主目录下，执行如下命令在后台指执行deploy脚本，进行环境部署。如[图 执行deploy脚本](#fig4285173816445)所示。
...
4.  开始编译，打开Mindstudio工具，在工具栏中点击**Build \> Build \> Build-Configuration**。如[图 编译操作及生成文件](#fig1625447397)所示，会在目录下生成build和run文件夹。
    ...
    **图 5**  编译操作及生成文件<a name="fig1625447397"></a>  
...
5.  <a name="li499911453439"></a>启动Presenter Server。
    ...
    打开Mind Studio工具的Terminal，在应用程序代码存放路径下，执行如下命令在后台启动Head Pose Estimation应用的Presenter Server主程序。如[图 启动PresenterServer](#fig423515251067)所示。

    **bash run\_present\_server.sh**

    **图 6**  启动PresenterServer<a name="fig423515251067"></a>  
    ...
    **图 7**  工程部署示意图<a name="fig999812514814"></a>  
    

    ![](figures/zh-cn_image_0219102259.jpg)

    如[图8](#fig69531305324)所示，表示presenter\_server的服务启动成功。

    **图 8**  Presenter Server进程启动<a name="fig69531305324"></a>  
    ...
    **图 10**  IP地址示例<a name="fig1881532172010"></a>  
    ![](figures/IP地址示例-46.png "IP地址示例-46")
...
1.  运行Head Pose Estimation程序。
    ...
    **图 11**  程序运行示例<a name="fig93931954162719"></a>  
...
2.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站，详细可参考[启动Presenter Server](#li499911453439)。
    ...
    等待Presenter Agent传输数据给服务端，单击“Refresh“刷新，当有数据时相应的Channel 的Status变成绿色，如[图12](#fig113691556202312)所示。

    **图 12**  Presenter Server界面<a name="fig113691556202312"></a>  
    ![](figures/Presenter-Server界面-47.png "Presenter-Server界面-47")
...
-   **停止Head Pose Estimation应用**
    ...
    **图 13**  停止Head Pose Estimation应用<a name="fig14326454172518"></a>  
    ...
    **图 14**  Head Pose Estimation应用已停止<a name="fig2182182518112"></a>  
