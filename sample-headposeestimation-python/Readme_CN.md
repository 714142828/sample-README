...
# 头部姿势估计（Python）<a name="ZH-CN_TOPIC_0228757086"></a>

开�者将本应用部署至Atlas 200 DK或者AI加速云�务器上实现对本地mp4文件或者RTSP视频�进行解�，对视频帧中的人脸图�进行头部姿势估计，并将预测的结果信���至Presenter Server端进行展示。
...
1.  <a name="li953280133816"></a>获���包。
    1.  下载压缩包方�获�。
        ...
        将[https://github.com/Atlas200dk/sample-headposeestimation-python](https://github.com/Atlas200dk/sample-headposeestimation-python)仓中的代�以Mind Studio安装用户下载至Mind Studio所在Ubuntu�务器的任�目录，例如代�存放路径为：$HOME/sample-headposeestimation-python。
...
2.  <a name="li12291771229"></a>获�此应用中所需�的网络模型。
    ...
    �考[表 头部姿势识别\(python\)使用模型](#table1119094515272)获�此应用中所用到的原始网络模型�其对应的��文件，并将其存放到Mind Studio所在Ubuntu�务器的任�目录，例如：$HOME/ascend/models/headposeestimation-python。
    ...
    **表 1**  头部姿势识别\(python\)使用模型
    ...
    <tbody><tr id="row3122314144215"><td class="cellrowborder" valign="top" width="12.85%" headers="mcps1.2.4.1.1 "><p id="p17514113810198"><a name="p17514113810198"></a><a name="p17514113810198"></a>face_detection</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.04%" headers="mcps1.2.4.1.2 "><p id="p14514123818199"><a name="p14514123818199"></a><a name="p14514123818199"></a>人脸检测网络模型。</p>
    <p id="p2514538131911"><a name="p2514538131911"></a><a name="p2514538131911"></a>此模型是基于Caffe的Resnet10-SSD300模型转��的网络模型。</p>
    </td>
    <td class="cellrowborder" valign="top" width="75.11%" headers="mcps1.2.4.1.3 "><p id="p10514138121916"><a name="p10514138121916"></a><a name="p10514138121916"></a>请�考<a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection</a>目录中README.md下载原始网络模型文件�其对应的��文件。</p>
    </td>
    </tr>
    <tr id="row1517495918114"><td class="cellrowborder" valign="top" width="12.85%" headers="mcps1.2.4.1.1 "><p id="p16541181214"><a name="p16541181214"></a><a name="p16541181214"></a>head_pose_estimation</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.04%" headers="mcps1.2.4.1.2 "><p id="p175415131212"><a name="p175415131212"></a><a name="p175415131212"></a>头部姿势估计网络模型。此模型是基于Caffe的VGG-SSD模型转��的网络模型</p>
    </td>
    <td class="cellrowborder" valign="top" width="75.11%" headers="mcps1.2.4.1.3 "><p id="p192971113151219"><a name="p192971113151219"></a><a name="p192971113151219"></a>请�考<a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/head_pose_estimation" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/head_pose_estimation</a>目录中README.md下载原始网络模型文件�其对应的��文件。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
3.  将原始网络模型转�为适�昇腾AI处�器的模型。
    ...
    2.  在弹出的**Model Conversion**�作界�中，Model File与Weight File分别选择[步骤2](#li12291771229)中下载的模型文件和��文件。
        ...
        -   face\_detection和head\_pose\_estimation模型都需�在AIPP�置界�将**Model Image Format**修改为BGR888\_U8。
        -   其他��默认值。
        -   face\_detection模型在转�时会失败，报错如[图 face\_detection模型转�失败](#fig149226521166)所示。

            **图 1**  face\_detection模型转�失败<a name="fig149226521166"></a>  
            ![](figures/face_detection模型转�失败.png "face_detection模型转�失败")
    ...
    4.  将转�好的模型文件（.om文件）上传到[步骤1](#li953280133816)中��所在路径下的“sample-headposeestimation-python/model�目录下。
...
1.  以Mind Studio安装用户进入headposeestimation-python应用代�所在根目录，如：$HOME/sample-headposeestimation-python。
...
3.  <a name="li156931456596"></a>�动Presenter Server。
    ...
    执行如下命令在���动Head Poseestimation应用的Presenter Server主程�。
    ...
    **图 2**  Presenter Server进程�动<a name="fig69531305324"></a>  
    ![](figures/Presenter-Server进程�动-61.png "Presenter-Server进程�动-61")

    使用上图�示的URL登录Presenter Server，仅支�Chrome�览器。IP地�为[步骤2](#li9634105881418)中输入的IP地�，端��默为7007，如下图所示，表示Presenter Server�动�功。

    **图 3**  主页显示<a name="fig64391558352"></a>  
    ![](figures/主页显示-62.png "主页显示-62")

    Presenter Server�Mind Studio与Atlas 200 DK之间通信使用的IP地�示例如下图所示：

    **图 4**  IP地�示例<a name="fig1881532172010"></a>  
    ![](figures/IP地�示例-63.png "IP地�示例-63")
...
4.  headposeestimation-python应用支�解�本地视频和RTSP视频�。
...
4.  使用�动Presenter Server�务时�示的URL登录 Presenter Server 网站，详细��考[�动Presenter Server](#li156931456596)。
    ...
    **图 5**  Presenter Server界�<a name="fig113691556202312"></a>  
    ![](figures/Presenter-Server界�-64.png "Presenter-Server界�-64")
