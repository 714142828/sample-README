...
2.  <a name="zh-cn_topic_0228757086_li12291771229"></a>获取此应用中所需要的网络模型。
    ...
    **表 1**  头部姿势识别\(python\)使用模型
    ...
    <td class="cellrowborder" valign="top" width="75.11%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0228757086_p10514138121916"><a name="zh-cn_topic_0228757086_p10514138121916"></a><a name="zh-cn_topic_0228757086_p10514138121916"></a>请参考<a href="https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection" target="_blank" rel="noopener noreferrer">https://github.com/Ascend-Huawei/models/tree/master/computer_vision/object_detect/face_detection</a>目录中README.md下载原始网络模型文件及其对应的权重文件。</p>
    </td>
    </tr>
